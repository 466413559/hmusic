							...
							<li>
								...
								<div class="songlist_item">
									<div class="songlist_songname">
										<span class="songlist_songname_txt"><a href="">${music.musicname}</a></span>
									...
									<div class="songlist_artist">
										<span class="singer_name">${singer.singername}</span>
									</div>
	...
	$
			.jqPaginator(
					'#page_nav2',
					{
						...
						prev : '<li class="prev"><a class="prev" href="singer?curPage=${curPage-1}"><</a></li>',
						next : '<li class="next"><a class="next" href="singer?curPage=${curPage+1}">></a></li>',
						page : '<li class="page"><a class="page" href="singer?curPage={{page}}">{{page}}</a></li>',
