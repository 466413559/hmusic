...
<!-- Modal -->
	...
	<div class="col-md-offset-3 col-md-6 top-menu">
					<ul class="menu-link">
						<li class="col-md-offset-2 col-md-2 top_subnav_item"><a  href="index" data-item="index" class="top_item top_item_current">首页</a></li>
					<li class="col-md-2 top_subnav_item"><a  href="singerlist" data-item="singerlist" class="top_item">歌手</a></li>
					<li class="col-md-2 top_subnav_item"><a  href="songlist?type=new" data-item="songlist" class="top_item">歌曲</a></li>
					<li class="col-md-2 top_subnav_item"><a  href="toplist?type=dlm" data-item="toplist" class="top_item">排行榜</a></li>
					</ul>
		...
		<script >
/* 	$(".top_subnav_item a[data-item='singerlist']").click(function(){
		$(".top_subnav_item a[data-item='index']")[0].innerHTML = "123";
		$(".top_subnav_item a[data-item='index']").removeClass('top_item_current');
		$(this).addClass('top_item_current');
		window.location.href="singerlist.jsp"
		$.ajax({
			url:"http://localhost:8080/hmusic/singerlist",
			type:"POST",
			contentType: "application/json;charset=utf-8",
			data:JSON.stringify({'curPage':1,'pageSize':10}),
			success:function(){
				window.location.href="singerlist.jsp"
			}
		})
	 ...
	 $(".top_subnav_item a[data-item='index']").click(function(){
	...
	/* $(".top_subnav_item a[data-item='songlist']").click(function(){
	
		$.ajax({
			url:"http://localhost:8080/hmusic/index",
			type:"POST",
			contentType: "application/json;charset=utf-8",
			data:JSON.stringify({'curPage':1,'pageSize':10}),
			success:function(){
