...
public class MusicServiceImpl implements MusicService {
	...
	public void upload(String musicname, String musicpath, String musicphotopath, String lyricspath,String basepath) {
		// TODO Auto-generated method stub
		Music music = new Music();
		music.setMusicname(musicname);
		
		MP3Info mp3tool = new MP3Info(basepath+Config.musicpath+musicpath);
