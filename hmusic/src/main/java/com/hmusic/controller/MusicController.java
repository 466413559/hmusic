...
public class MusicController {
	...
	public String add(@RequestParam(value = "musicpath", required = false) MultipartFile musicfile,
		...
		// 歌曲文件名 歌曲头像名 歌词文件名
		String musicpath = musicfile.getOriginalFilename().replace(" ","");
		String musicphotopath = musicphotofile.getOriginalFilename().replace(" ", "");
		String lyricspath = lyricsfile.getOriginalFilename().replace(" ","");
		...
		musicService.upload(musicname, musicpath, musicphotopath, lyricspath,basePath);
